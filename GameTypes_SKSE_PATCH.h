...
/*typedef void(*LOCK_VOID)(void);
typedef bool(*LOCK_BOOL)(void);
...
RelocAddr<LOCK_VOID> BSReadWriteLock_LockForReadAndWrite(0x00C07640);
// unused function 0x00C076C0
RelocAddr<LOCK_BOOL> BSReadWriteLock_TryLockForWrite(0x00C07730);
RelocAddr<LOCK_VOID> BSReadWriteLock_UnlockRead(0x00C07780);
RelocAddr<LOCK_VOID> BSReadWriteLock_UnlockWrite(0x00C07790);
...
public:
	...
	//void LockForRead();
	//void LockForWrite();
	DEFINE_MEMBER_FN_0(LockForRead, void, 0x00C074C0);
	DEFINE_MEMBER_FN_0(LockForWrite, void, 0x00C07540);
	DEFINE_MEMBER_FN_0(UnlockRead, void, 0x00C07780);
	DEFINE_MEMBER_FN_0(UnlockWrite, void, 0x00C07790);
	DEFINE_MEMBER_FN_0(LockForReadAndWrite, void, 0x00C07640);
	DEFINE_MEMBER_FN_0(TryLockForWrite, bool, 0x00C07730);
};
